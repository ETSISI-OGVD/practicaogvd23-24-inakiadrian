...
workspace_name = "ml_lab3_ws" # PLACEHOLDER
subscription_id = "4e671023-40f4-4c63-bad1-3632f1a22079" # PLACEHOLDER
resource_group = "ml_lab3" # PLACEHOLDER
experiment_name = "WaterPotabiliy" # PLACEHOLDER
iteration = "41"  # PLACEHOLDER
run_id = "stoic_cloud_f32b2r9dt1_41"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'is_subgraph_orchestration':False,'is_automode':True,'path':'./sample_projects/','subscription_id':'4e671023-40f4-4c63-bad1-3632f1a22079','resource_group':'ml_lab3','workspace_name':'ml_lab3_ws','iterations':1000,'primary_metric':'AUC_weighted','task_type':'classification','IsImageTask':False,'IsTextDNNTask':False,'validation_size':0.1,'test_size':0.1,'n_cross_validations':None,'preprocess':True,'is_timeseries':False,'time_column_name':None,'grain_column_names':None,'max_cores_per_iteration':-1,'max_concurrent_iterations':1,'max_nodes':1,'iteration_timeout_minutes':30,'enforce_time_on_windows':False,'experiment_timeout_minutes':360,'exit_score':'NaN','experiment_exit_score':'NaN','whitelist_models':None,'blacklist_models':['LogisticRegression','SGD','BernoulliNaiveBayes','DecisionTree','LightGBM','LinearSVM'],'blacklist_algos':['LogisticRegression','SGD','BernoulliNaiveBayes','DecisionTree','LightGBM','LinearSVM','TensorFlowLinearClassifier','TensorFlowDNN'],'auto_blacklist':False,'blacklist_samples_reached':False,'exclude_nan_labels':False,'verbosity':20,'model_explainability':True,'enable_onnx_compatible_models':False,'enable_feature_sweeping':False,'send_telemetry':True,'enable_early_stopping':True,'early_stopping_n_iters':20,'distributed_dnn_max_node_check':False,'enable_distributed_featurization':True,'enable_distributed_dnn_training':True,'enable_distributed_dnn_training_ort_ds':False,'ensemble_iterations':15,'enable_tf':False,'enable_cache':False,'enable_subsampling':False,'metric_operation':'maximize','enable_streaming':False,'use_incremental_learning_override':False,'force_streaming':False,'enable_dnn':False,'is_gpu_tmp':False,'enable_run_restructure':False,'featurization':'auto','vm_type':'Standard_DS3_v2','vm_priority':'dedicated','label_column_name':'Potability','weight_column_name':None,'miro_flight':'default','many_models':False,'many_models_process_count_per_node':0,'automl_many_models_scenario':None,'enable_batch_run':True,'save_mlflow':True,'track_child_runs':True,'test_include_predictions_only':False,'enable_mltable_quick_profile':'True','has_multiple_series':False,'_enable_future_regressors':False,'enable_ensembling':True,'enable_stack_ensembling':False,'ensemble_download_models_timeout_sec':300.0,'stack_meta_learner_train_percentage':0.2} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'classification','primary_metric':'AUC_weighted','verbosity':20,'ensemble_iterations':15,'ensemble_download_models_timeout_sec':300,'is_timeseries':False,'subscription_id':'4e671023-40f4-4c63-bad1-3632f1a22079','time_column_name':None,'grain_column_names':None}\",\"ensemble_run_id\":\"stoic_cloud_f32b2r9dt1_41\",\"experiment_name\":\"WaterPotabiliy\",\"workspace_name\":\"ml_lab3_ws\",\"subscription_id\":\"4e671023-40f4-4c63-bad1-3632f1a22079\",\"resource_group_name\":\"ml_lab3\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = None # PLACEHOLDER
mltable_data_json = "{\"Type\":\"MLTable\",\"TrainData\":{\"Uri\":\"azureml://locations/westeurope/workspaces/1c34b3f9-97a4-4dde-9d34-636a2d008ac9/data/Water_potability_clean/versions/1\",\"ResolvedUri\":\"azureml://locations/westeurope/workspaces/1c34b3f9-97a4-4dde-9d34-636a2d008ac9/data/Water_potability_clean/versions/1\",\"AssetId\":\"azureml://locations/westeurope/workspaces/1c34b3f9-97a4-4dde-9d34-636a2d008ac9/data/Water_potability_clean/versions/1\"},\"TestData\":null,\"ValidData\":null}" # PLACEHOLDER
